...
const Forget = () => {
  ...
  const [success, setSuccess] = useState(""); // To store and display success messages
  const navigate = useNavigate(); // For redirection to the login page
  ...
  const sendRequest = async () => {
    try {
      const res = await axios.post("YOUR_BACKEND_API_ENDPOINT", {
        email: inputs.email,
